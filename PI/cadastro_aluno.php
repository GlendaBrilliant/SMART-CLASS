...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO alunos (nome, email, estado, cidade, endereco, telefone, foto_perfil, senha) 
            VALUES ('$nome','$email','$estado','$cidade','$endereco','$telefone','$foto','$senha')";

    if ($conn->query($sql) === TRUE) {
        header("Location: login.php?success=aluno");
        exit();
    } else {
...
<div class="cadastro">
    ...
    <form method="POST" enctype="multipart/form-data">
        ...
        <div class="cadastroCheckBox">
            <input type="checkbox" required> Eu aceito os termos de <a href="">privacidade</a><br>
        </div>
